...
class Book:
    ...
    def __str__(self) -> str:
        """
        Возвращаем строковое представление книги
        строка формата 'Книга "название_книги"'
        """
        return f'Книга "{self.name}"'

    def __repr__(self) -> str:
        """
        Возвращаем валидную Python-строку для создания такого же экземпляра
        строка формата Book(id_=1, name='test_name_1', pages=200)
        """
...
class Library:
    ...
    def get_next_book_id(self) -> int:
        ...
        return: следующий доступный id для книги
        """
        if not self.books:
            return 1
        else:
